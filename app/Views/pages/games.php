            ...
            <div class="card-body">
                ...
                <div class="card-px py-5 flex-grow-1" id="games-list">
                    ...
                    <div class="edit-game top-0 start-0">
                        <!--begin::Edit Wrapper-->
                        <form class="d-flex flex-row justify-content-start gap-12">
                            <!--begin::Form-->
                            <form action="/games/change_icon" method="post">
                                ...
                                <div class="d-flex flex-column gap-6 align-items-start text-start">
                                    ...
                                    <div class="d-flex flex-row flex-wrap gap-4">
                                        <label for="game-img"
                                               class="btn p-1 text-hover-primary fs-7">Cambiar</label>
                                        <button class="btn p-1 text-hover-danger fs-7 del-game-img">Borrar
                                        </button>
                                    </div>
                                </div>
                                <!--end::Icon-->
                                ...
                                <div class="d-flex flex-column w-50">
                                    ...
                                    <div class="mt-5 d-flex flex-row gap-4 justify-content-between">
                                        ...
                                        <button class="btn btn-primary py-2 px-4" value="<?= $game['idGame'] ?>">
                                            Guardar
                                        </button>
                                    </div>
                                    <!--end::Buttons-->
