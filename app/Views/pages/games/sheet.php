<?php if (isset($sheet)) { ?>
    ...
    <ul class="nav nav-tabs pt-2 justify-content-start fs-7">
        ...
        <li class="nav-item d-none">
            <a class="nav-link py-2 px-3" data-bs-toggle="tab" href="#draggable_<?= $sheet['item_id'] ?>-spells">
                    ...
                    <div class="flex-row-wrap row-cols-2 justify-content-center mt-5 p-4 gap-5">
                        ...
                        <div class="flex-column align-items-center justify-content-start position-relative w-70px h-100px">
                            ...
                            <div class="this-outline combat-item flex-column align-items-center justify-content-center position-absolute top-15px">
                                <button type="button" class="btn p-0 combat-item_title text-hover-primary">STRENGTH
                                </button>
                        ...
                        <div class="flex-column align-items-center justify-content-start position-relative w-70px h-100px">
                            <!--begin::Row-->
                            <div class="this-outline combat-item flex-column align-items-center justify-content-center position-absolute top-15px">
                                <button type="button" class="btn p-0 combat-item_title text-hover-primary">WISDOM
                                </button>
                        ...
                        <div class="flex-column align-items-center justify-content-start position-relative w-70px h-100px">
                            <!--begin::Row-->
                            <div class="this-outline combat-item flex-column align-items-center justify-content-center position-absolute top-15px">
                                <button type="button" class="btn p-0 combat-item_title text-hover-primary">CHARISMA
                                </button>
