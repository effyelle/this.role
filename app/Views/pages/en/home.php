...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <div class="sidebar-card d-none d-lg-flex">
            <img class="sidebar-card-illustration mb-2" src="<?= base_url(); ?>dist/img/undraw_rocket.svg" alt="...">
                        ...
                        <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                            ...
                            <a class="dropdown-item d-flex align-items-center" href="<?= base_url(); ?>#">
                                <div class="dropdown-list-image mr-3">
                                    <img class="rounded-circle" src="<?= base_url(); ?>dist/img/undraw_profile_1.svg"
                                         alt="...">
                            ...
                            <a class="dropdown-item d-flex align-items-center" href="<?= base_url(); ?>#">
                                <div class="dropdown-list-image mr-3">
                                    <img class="rounded-circle" src="<?= base_url(); ?>dist/img/undraw_profile_2.svg"
                                         alt="...">
                            ...
                            <a class="dropdown-item d-flex align-items-center" href="<?= base_url(); ?>#">
                                <div class="dropdown-list-image mr-3">
                                    <img class="rounded-circle" src="<?= base_url(); ?>dist/img/undraw_profile_3.svg"
                                         alt="...">
                            ...
                            <div class="card-body">
                                <div class="text-center">
                                    <img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 25rem;"
                                         src="<?= base_url(); ?>dist/img/undraw_posting_photo.svg" alt="...">
                                </div>
